...
1. [/etc/hostname](https://github.com/bit20205/rocky-practices/blob/main/lx/etc/hostname) 호스트 이름 설정
```sh
lx.kickscar.com
```
...
2. [/etc/sysctl.conf](https://github.com/bit20205/rocky-practices/blob/main/lx/etc/sysctl.conf) 설정
```sh
...
2. 두 번째부터 수정 가능
   [/etc/NetworkManager/system-connectios/enp0s1.nmconnection](https://github.com/bit20205/rocky-practices/blob/main/lx/etc/NetworkManager/system-connectios/enp0s1.nmconnection)
